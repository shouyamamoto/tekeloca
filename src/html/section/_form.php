        ...
        <form action="mail.php" method="post">
            <ul class="form-items">
                ...
                <li class="form-item">
                    ...
                    <input type="tel" id="tel" name="tel" placeholder="例) 080-1111-2222" required>
                </li>

                <li class="form-item">
                    <label for="mail"><span class="need">必須</span>メールアドレス</label>
                    <input type="text" id="mail" name="mail" placeholder="例) example@gmail.com" required>
                </li>

                <li class="form-item">
                    <label for="place"><span class="need">必須</span>撮影希望場所</label>
                    <input type="text" id="place" name="place" placeholder="例) 大阪府 万博記念公園" required>
                </li>
                ...
                <li class="form-item">
                    ...
                    <ul>
                        <li class="form-item__plan">
                            <input type="radio" name="plan" id="icon" value="アイコン撮影プラン" checked>
                            <label for="icon">アイコン撮影プラン</label>
                        </li>

                        <li class="form-item__plan">
                            <input type="radio" name="plan" id="couple" value="カップル撮影プラン">
                            <label for="couple">カップル撮影プラン</label>
                        </li>

                        <li class="form-item__plan">
                            <input type="radio" name="plan" id="wedding"　value="結婚式撮影プラン">
